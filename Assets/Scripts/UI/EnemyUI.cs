...
namespace TowerDefese
{
    public class EnemyUI : MonoBehaviour
    {
        ...
        public void CreateInfoUI(IEnemy enemy)
        {
            ...
            var healthText = healthImage.GetComponentInChildren<Text>();
            var hp = " HP: ";
            var armorText = enemyUI.transform.Find("ArmorImage").GetComponentInChildren<Text>();
            var speedText = enemyUI.transform.Find("Speed").GetComponentInChildren<Text>();
            healthText.text = hp + enemy.Health;
            armorText.text = "Броня " + enemy.Armor.ToString();
            speedText.text = "Скорость: " + enemy.Speed.ToString();
